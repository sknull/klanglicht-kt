...
import de.visualdigits.klanglicht.hardware.lightmanager.model.html.page.components.LMHtmlColorWheel
...
class LMHtmlSceneGroup(
    ...
    override fun html(indent: Int): String {
        ...
        if (sceneGroup.hasColorWheel) {
            sb.append(LMHtmlColorWheel(prefs, sceneGroup).html(indent))
        }
        return sb.toString()
    }
}
