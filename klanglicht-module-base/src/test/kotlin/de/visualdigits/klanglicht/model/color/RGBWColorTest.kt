...
internal class RGBWColorTest {
    ...
    fun convertTest() {
        ...
        val rgbw = rgb.toRgbwColor()
        assertEquals("[127, 0, 0, 128]", rgbw.toString())
        val rgb2: RGBColor = rgbw.toRgbColor()
    ...
    fun mixTestTwoColors() {
        ...
        val mixed = color1.fade(color2, 0.5, BlendMode.AVERAGE)
    ...
    fun mixTestDifferentWhites() {
        ...
        assertEquals("#000000ff", color1.fade(color2, 0.1, BlendMode.AVERAGE).web())
        assertEquals("#000000ff", color1.fade(color2, 0.2, BlendMode.AVERAGE).web())
        assertEquals("#000000ff", color1.fade(color2, 0.3, BlendMode.AVERAGE).web())
        assertEquals("#000000ff", color1.fade(color2, 0.4, BlendMode.AVERAGE).web())
        assertEquals("#000000ff", color1.fade(color2, 0.5, BlendMode.AVERAGE).web())
        assertEquals("#000000ff", color1.fade(color2, 0.6, BlendMode.AVERAGE).web())
        assertEquals("#000000ff", color1.fade(color2, 0.7, BlendMode.AVERAGE).web())
        assertEquals("#000000ff", color1.fade(color2, 0.8, BlendMode.AVERAGE).web())
        assertEquals("#000000ff", color1.fade(color2, 0.9, BlendMode.AVERAGE).web())
    }
}
