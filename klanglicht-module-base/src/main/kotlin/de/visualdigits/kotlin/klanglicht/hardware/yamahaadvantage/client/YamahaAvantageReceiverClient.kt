...
class YamahaAvantageReceiverClient(val yamahaReceiverUrl: String) {
    ...
    fun features(): de.visualdigits.kotlin.klanglicht.hardware.yamahaadvantage.model.features.Features {
        val features = URL("$yamahaReceiverUrl/YamahaExtendedControl/v1/system/getFeatures").readText()
        return mapper.readValue(features, de.visualdigits.kotlin.klanglicht.hardware.yamahaadvantage.model.features.Features::class.java)
    }

    fun soundProgramList(): de.visualdigits.kotlin.klanglicht.hardware.yamahaadvantage.model.SoundProgramList {
        val soundProgramList = URL("$yamahaReceiverUrl/YamahaExtendedControl/v1/main/getSoundProgramList").readText()
        return mapper.readValue(soundProgramList, de.visualdigits.kotlin.klanglicht.hardware.yamahaadvantage.model.SoundProgramList::class.java)
    }
    ...
    fun setSurroundProgram(program: String): de.visualdigits.kotlin.klanglicht.hardware.yamahaadvantage.model.ResponseCode {
        ...
        return try {
            mapPrograms[program]
                ...
                ?.let { mapper.readValue(it, de.visualdigits.kotlin.klanglicht.hardware.yamahaadvantage.model.ResponseCode::class.java) }
                ?: de.visualdigits.kotlin.klanglicht.hardware.yamahaadvantage.model.ResponseCode(0)
